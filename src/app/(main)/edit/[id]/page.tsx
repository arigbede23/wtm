// Edit Event Page — same 3-step wizard as create, but pre-filled with existing event data.
// Verifies the current user is the organizer before allowing edits.
    ...
    return (
      <div className="flex flex-col items-center justify-center p-8 text-center">
        ...
        <p className="mt-1 text-sm text-gray-500">
          You need to be signed in to edit an event.
        </p>
        <Link
          href="/login"
