// Header — sticky top bar with the app logo and search button.
...
export function Header() {
  return (
    // "sticky top-0" keeps the header pinned to the top when scrolling
    <header className="sticky top-0 z-40 border-b border-gray-200 bg-white/80 backdrop-blur-lg dark:border-gray-800 dark:bg-gray-950/80">
      <div className="mx-auto flex max-w-md items-center justify-between px-4 py-3">
        ...
        {/* Search button — functionality coming in Phase 2 */}
